...
describe('SelectDateComponent', () => {
  ...
  //   expect(component.now.toISODate()).toBe(today.toISODate());
  // });
  //
  ...
  //   component.amountOfDaySlotsInContainer = 7;
  //
  //   component.processNewStartDateTime(sourceDatetime);
  //
  ...
  //   // Manually populate dayItemList with dummy data
    //   component.slotsLocalService.setDayItemList(generateDayItemList(now, sourceDatetime, component.amountOfDaySlotsInContainer));
  //
  //   // Use jest.spyOn instead of spyOn from Jasmine
  //   const prepareDatetimeListSpy = jest.spyOn(component, 'processNewStartDateTime');
  //
  ...
  //
  //   // Use jest.spyOn instead of spyOn from Jasmine
  //   const prepareDatetimeListSpy = jest.spyOn(component, 'processNewStartDateTime').mockImplementation((): any => {
  ...
  //     const nextSourceDatetime = sourceDatetime.plus({day: component.amountOfDaySlotsInContainer});
    //     component.slotsLocalService.setDayItemList(generateDayItemList(now, nextSourceDatetime, component.amountOfDaySlotsInContainer));
  //   });
  //
