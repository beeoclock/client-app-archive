...
export const enum NotificationStateEnum {
  SUCCESS = 'SUCCESS',
  WARNING = 'WARNING',
  DANGER = 'DANGER',
  INFO = 'INFO',
...
export class Notification {
  protected static _stream$: Subject<Notification> =
    new Subject<Notification>();
  public static stream$: Observable<Notification> =
    this._stream$.asObservable();
...
export class WarningNotification extends Notification {
  constructor(public override readonly data: INotificationData) {
