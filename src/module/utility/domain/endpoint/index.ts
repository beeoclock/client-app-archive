...
export class Endpoint {
  ...
  public static registerEndpointPackage(
    endpointPackage: Record<string, EndpointInterface>,
  ): void {
  ...
  @TypeGuard([is.not_empty])
  public static registerEndpointCollection(
    endpointCollection: EndpointCollectionType,
  ): void {
