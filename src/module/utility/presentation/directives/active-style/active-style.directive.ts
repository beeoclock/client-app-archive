  ...
  public initActive(): void {
    ...
    switch (this.active) {
      case ActiveEnum.NO:
        ...
        text =
          this.inactiveText ??
          this.translateService.instant('keyword.capitalize.inactive');
        break;
      ...
      case ActiveEnum.YES:
        ...
        text =
          this.activeText ??
          this.translateService.instant('keyword.capitalize.active');
        break;
      ...
      default:
        this.elementRef.nativeElement.classList.add(
          'bg-beeColor-500',
          'border-beeColor-500',
          'dark:bg-beeColor-900',
          'dark:text-beeColor-400',
          'dark:border-beeColor-800',
        );
        text =
          this.activeText ??
          this.translateService.instant('keyword.capitalize.unknown');
    }
