...
export class InjectionComponentService {
  private _container: ComponentRef<any> | undefined;
  ...
  public appendComponent<T>(
    ...
    const componentRef: ComponentRef<any> =
      this.getComponentRefAndAssignDataAndRegisterToAppView<T>(
        componentClass,
        options,
        projectableNodes,
        rootSelectorOrNode,
  ...
  public getComponentRefAndAssignDataAndRegisterToAppView<T>(
    ...
    const componentRef: ComponentRef<T> = this.getComponentRefAndAssignData<T>(
      componentClass,
      options,
      projectableNodes,
      rootSelectorOrNode,
  ...
  public getComponentRefAndAssignData<T>(
    ...
    const componentRef: ComponentRef<T> = this.getComponentRef<T>(
      componentClass,
      projectableNodes,
      rootSelectorOrNode,
      ngModule,
