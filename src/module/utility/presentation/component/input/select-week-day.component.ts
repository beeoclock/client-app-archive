...
@Component({
  ...
  template: `
    ...
    <div class="grid grid-cols-7 gap-2">
      ...
      >
        <button
          class="w-full rounded-xl border py-1.5 text-center dark:border-beeDarkColor-700 dark:bg-beeDarkColor-800 dark:text-white"
...
export class SelectWeekDayComponent {
  ...
  public selectedClass(isSelected: boolean): Record<string, boolean> {
    return {
      ...
      'dark:bg-beeDarkColor-800 dark:border-beeDarkColor-700 dark:text-white':
        !isSelected,
    };
  }
}
