...
export class ModalSelectServiceService extends Reactive {
  ...
  public async openServiceModal(
    ...
    const title = await this.translateService.instant(
      'event.form.section.service.modal.title',
    );
    ...
    return new Promise((resolve, reject) => {
      const buttons: ModalButtonInterface[] = [
        {
          ...
          classList:
          ModalComponent.buttons[ModalButtonRoleEnum.cancel].classList,
        ...
        },
        {
          ...
          classList:
          ModalComponent.buttons[ModalButtonRoleEnum.accept].classList,
          role: ModalButtonRoleEnum.accept,
          enabledDebounceClick: true,
          callback: (modal: ModalComponent) => {
            const component = modal.componentChildRefList[0]
              .instance as unknown as ModalSelectServiceComponent;
      ...
      this.modalService
        ...
        .then((modal) => {
          const component = modal.instance.componentChildRefList[0]
            .instance as unknown as ModalSelectServiceComponent;
          const acceptButton = modal.instance.getButton(
